    ...
    _createClass(ReactBingmaps, [{
        ...
        value: function reactBingmaps(props, Microsoft) {
            var bingmapKey = props.bingmapKey,
                ...
                mapRef = props.mapRef,
                postInitializeCallback = props.postInitializeCallback,
                initOptions = props.getInitOptions?.() ?? {};
            ...
            if (bingmapKey && Microsoft) {
                ...
                if (mapRef) {
                    mapRef.current = map[mapReference];
                }
            ...
            if (map[mapReference] && polylines) {
                ...
                for (var polyline of polylines) {
                    ...
                    for (var polylineLocationIndex = 0; polylineLocationIndex < polylineLocations.length && polylineLocations[polylineLocationIndex][0] && polylineLocations[polylineLocationIndex][1]; polylineLocationIndex++) {
                        var locations = new Microsoft.Maps.Location(polylineLocations[polylineLocationIndex][0], polylineLocations[polylineLocationIndex][1]);
                        polylineLocationsAsMapLocations.push(locations);
                    }
...
ReactBingmaps.defaultProps = {
    ...
    mapRef: undefined,
    postInitializeCallback: undefined,
    getInitOptions: undefined
};